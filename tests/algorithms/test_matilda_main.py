...
@patch('matilda_cli.algorithms.matilda.instantiate_tgd')
@patch('matilda_cli.algorithms.matilda.TGDRuleFactory.str_to_tgd')
@patch('matilda_cli.algorithms.matilda.split_pruning')
@patch('matilda_cli.algorithms.matilda.split_candidate_rule')
@patch('matilda_cli.algorithms.matilda.dfs')
@patch('matilda_cli.algorithms.matilda.init')
