...
from matilda_cli.database.data_exporter import DataExporter
from matilda_cli.database.database_connection_manager import DatabaseConnectionManager
from matilda_cli.database.index_manager import IndexManager
from matilda_cli.database.query_utility import QueryUtility
from matilda_cli.database.triple_converter import TripleConverter
            ...
            if column in foreign_keys[table]:
                ...
                if referenced_table == other_table and referenced_column == other_column:
                    ...
                    self.logger_query_time.error(
                        f"Incorrect foreign key for table '{table}': '{column}' references '{referenced_table}.{referenced_column}' instead of '{other_table}.{other_column}'."
                    )
                    return False
